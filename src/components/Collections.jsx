                ...
                <div className="grps">
                    ...
                    <a href='#' className='link'>
                        <div className='flex-column text-center fw-bolder'>
                                <img src={b1} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b2} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b3} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                        <a href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b4} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b5} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b6} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b7} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={b8} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                                <h5 className='fw-bolder'><u>Mercurial Football Shoes</u></h5>
                            </div>
                        </a>
                    ...
                    <a  href='#' className='link'>
                        <div id='n1' className='flex-column text-center fw-bolder'>
                                <img src={s1} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s2} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s3} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s4} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s5} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s6} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link' >
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s7} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src={s8} alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                    ...
                    <a  href='#' className='link'>
                        <div className='flex-column text-center fw-bolder'>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4DIz8jPwpAmDZV0x-HNwoDg_ZphyhqREo1qUv5WwrBQ&s" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                       ...
                       <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://www.rebelsport.com.au/dw/image/v2/BBRV_PRD/on/demandware.static/-/Sites-srg-internal-master-catalog/default/dw2e8817d6/images/60901901/Rebel_60901901-00_blackwhite_hi-res.jpg?sw=750&sh=750&sm=fit&q=60" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://m.media-amazon.com/images/I/51YyHzzf9+L._SY500_.jpg" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/585e2cd2-4f2a-408c-a8ba-f89952cdf332/revolution-6-road-running-shoes-NC0P7k.png" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://images-eu.ssl-images-amazon.com/images/I/51crsMMADTL._AC_UL600_SR600,600_.jpg" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrc_nYt9gIgZ6pgg_uIRpiu9XJhjdKRFt-Z5Llq8-Uu6GdaPtMcE4c7RzzmC3dXKNYYS4&usqp=CAU" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/6c8f8b93-fce2-4c6d-a597-2ddb06dfa4b7/structure-25-road-running-shoes-tFBSvw.png" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
                        ...
                        <a  href='#' className='link'>
                            <div className='flex-column text-center fw-bolder'>
                                <img src="https://i.ebayimg.com/images/g/tgMAAOSwivNiHmmP/s-l400.jpg" alt="" style={{width:'400px',height:'400px'}}/>
                                <p>₹3000</p>
